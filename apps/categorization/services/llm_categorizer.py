...
class LLMCategorizer(BaseCategorizer):
    ...
    def categorize(
        ...
        results = self.categorize_batch([transaction], valid_categories, user_history)
        return results[0]
    ...
    def categorize_batch(
        ...
        try:
            prompt = self._build_prompt(transactions, valid_categories, user_history)
            ...
            return self._parse_response(response, transactions, valid_categories)
            ...
            for pred in data['predictions']:
                try:
                    ...
                    if 0 <= idx < len(transactions):
                        ...
                        results[idx] = CategoryPrediction(category, confidence)
